...
interface TiptapEditorWithVariablesProps {
  content: string;
...
export default function TiptapEditorWithVariables({
  content,
  onChange,
      ...
      <div className="flex flex-wrap items-center gap-1 border-b border-gray-300 p-2 dark:border-gray-700">
        ...
        {variables.length > 0 && (
          <div className="relative">
            ...
            {showVariables && (
              <div className="absolute left-0 top-full z-50 mt-1 max-h-80 w-64 overflow-y-auto rounded-lg border border-gray-300 bg-white shadow-lg dark:border-gray-700 dark:bg-gray-800">
        ...
        <button
          ...
          className={`rounded px-3 py-1.5 text-xs font-medium hover:bg-gray-100 dark:hover:bg-gray-800 ${
            showHTMLView ? "bg-gray-200 dark:bg-gray-700" : ""
          }`}
        >
      ...
      <div className="prose prose-sm max-w-none dark:prose-invert">
        {showHTMLView ? (
          <textarea
            ...
            className="min-h-[200px] w-full border-0 bg-transparent p-4 font-mono text-sm focus:outline-none"
          />
        ) : (
